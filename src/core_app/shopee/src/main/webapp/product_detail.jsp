                                                    ...
                                                    <c:forEach var="r" items="${reviews}">
                                                        <div class="review-item" data-rating="${r.rating}"
                                                            ...
                                                            <div class="user-avatar"
                                                                ...
                                                                <c:choose>
                                                                    <c:when test="${not empty r.userAvatar}">
                                                                        <img src="${r.userAvatar}" alt="${r.username}"
                                                                            style="width: 100%; height: 100%; object-fit: cover;"
                                                                            onerror="this.style.display='none'; this.nextElementSibling.style.display='block';">
                                                                        <i class="fas fa-user" style="color: #c6c6c6; font-size: 20px; display: none;"></i>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                        <i class="fas fa-user" style="color: #c6c6c6; font-size: 20px;"></i>
                                                                    </c:otherwise>
                                                                </c:choose>
                                                            </div>
                                                            <div class="review-main" style="flex: 1;">
                                                                ...
                                                                <div class="review-content"
                                                                    style="font-size: 14px; color: rgba(0,0,0,.87); line-height: 1.5; white-space: pre-line;">${r.comment}</div>

                                                                <c:if test="${not empty r.mediaList}">
                                                                    <div class="review-media"
                                                                        style="margin-top: 15px; display: flex; gap: 10px; flex-wrap: wrap;">
                                                                        <c:forEach var="media" items="${r.mediaList}">
                                                                            <c:choose>
                                                                                <c:when test="${media.type == 'video'}">
                                                                                    <div style="width: 120px; height: 90px; cursor: pointer; position: relative; border-radius: 4px; overflow: hidden; background: #000;">
                                                                                        <video src="${pageContext.request.contextPath}/${media.url}" style="width: 100%; height: 100%; object-fit: cover;"
                                                                                            onclick="this.paused ? this.play() : this.pause();"
                                                                                            preload="metadata"></video>
                                                                                        <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%,-50%); color: #fff; font-size: 24px; pointer-events: none; opacity: 0.8;">
                                                                                            <i class="fas fa-play-circle"></i>
                                                                                        </div>
                                                                                    </div>
                                                                                </c:when>
                                                                                <c:otherwise>
                                                                                    <div style="width: 72px; height: 72px; cursor: pointer; border-radius: 4px; overflow: hidden; border: 1px solid rgba(0,0,0,.09);">
                                                                                        <img src="${pageContext.request.contextPath}/${media.url}" alt="Review media"
                                                                                            style="width: 100%; height: 100%; object-fit: cover;"
                                ...
                                <c:if test="${not empty sessionScope.account}">
                                    <c:choose>
                                        <c:when test="${hasReviewed}">
                                            <div class="section-box" style="margin-top: 20px; text-align: center; padding: 25px;">
                                                <i class="fas fa-check-circle" style="font-size: 32px; color: #27ae60; margin-bottom: 10px;"></i>
                                                <div style="font-size: 14px; color: rgba(0,0,0,.65);">Bạn đã đánh giá sản phẩm này. Cảm ơn bạn!</div>
                                            </div>
                                        </c:when>
                                        <c:when test="${canReview}">
                                            <div class="section-box" style="margin-top: 20px;">
                                                ...
                                                <form action="submit_review" method="post" enctype="multipart/form-data"
                                                    ...
                                                    <!-- Upload Ảnh/Video -->
                                                    <div>
                                                        <label style="font-size: 14px; color: rgba(0,0,0,.87); margin-bottom: 8px; display: block;">Thêm Hình Ảnh / Video:</label>
                                                        <div style="display: flex; align-items: flex-start; gap: 10px; flex-wrap: wrap;">
                                                            <label for="reviewMediaInput" 
                                                                style="width: 80px; height: 80px; border: 2px dashed rgba(0,0,0,.15); border-radius: 4px; display: flex; flex-direction: column; align-items: center; justify-content: center; cursor: pointer; color: #ee4d2d; transition: border-color 0.2s, background 0.2s;"
                                                                onmouseover="this.style.borderColor='#ee4d2d'; this.style.background='rgba(238,77,45,0.04)';"
                                                                onmouseout="this.style.borderColor='rgba(0,0,0,.15)'; this.style.background='transparent';">
                                                                <i class="fas fa-camera" style="font-size: 22px; margin-bottom: 4px;"></i>
                                                                <span style="font-size: 11px; color: rgba(0,0,0,.54);">Thêm ảnh</span>
                                                            </label>
                                                            <input type="file" id="reviewMediaInput" name="media" multiple 
                                                                accept="image/jpeg,image/png,image/webp,image/gif,video/mp4,video/webm"
                                                                style="display: none;" onchange="previewReviewMedia(this)">
                                                            <div id="mediaPreviewContainer" style="display: flex; gap: 10px; flex-wrap: wrap;"></div>
                                                        </div>
                                                        <div style="font-size: 12px; color: rgba(0,0,0,.4); margin-top: 6px;">Tối đa 5 ảnh/video, mỗi file tối đa 10MB. Định dạng: JPG, PNG, WEBP, GIF, MP4, WEBM</div>
                                                    </div>
                                        ...
                                        <c:otherwise>
                                            <div class="section-box"
                                                ...
                                                <div style="margin-bottom: 15px;">
                                                    <i class="fas fa-shopping-bag" style="font-size: 40px; color: #ccc;"></i>
                                                </div>
                                                <div style="font-size: 16px; color: rgba(0,0,0,.87); margin-bottom: 8px;">
                                                    Bạn cần mua và nhận sản phẩm này trước khi có thể viết đánh giá
                                                </div>
                                                <div style="font-size: 13px; color: rgba(0,0,0,.54);">
                                                    Chỉ những khách hàng đã hoàn thành đơn hàng mới được phép đánh giá sản phẩm
                                                </div>
                                            </div>
                                        </c:otherwise>
                                    </c:choose>
                                ...
                                <% } else { %>
                                    ...
                                    <% }%>
                                        ...
                                        <script>
                                            ...
                                            // ============================================================
                                            // 10. MEDIA PREVIEW (UPLOAD ĐÁNH GIÁ)
                                            // ============================================================
                                            function previewReviewMedia(input) {
                                                ...
                                                for (let i = 0; i < files.length; i++) {
                                                    ...
                                                    wrapper.style.cssText = 'width: 80px; height: 80px; position: relative; border-radius: 4px; overflow: hidden; border: 1px solid rgba(0,0,0,.09);';
                                                    ...
                                                    reader.onload = function(e) {
                                                        if (file.type.startsWith('video')) {
                                                            ...
                                                            playIcon.style.cssText = 'position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); color: #fff; font-size: 20px; pointer-events: none; text-shadow: 0 1px 3px rgba(0,0,0,.5);';
                                                        ...
                                                        removeBtn.style.cssText = 'position: absolute; top: 2px; right: 2px; width: 18px; height: 18px; background: rgba(0,0,0,.6); color: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 10px; cursor: pointer;';
                                            ...
                                            // ============================================================
                                            // 11. LIGHTBOX XEM ẢNH REVIEW
                                            // ============================================================
                                            function openReviewImage(src) {
                                                const overlay = document.getElementById('reviewImageOverlay');
                                        ...
                                        <div id="reviewImageOverlay" onclick="closeReviewImage()"
                                            style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,.85); z-index: 99999; align-items: center; justify-content: center; cursor: pointer;">
                                            <img id="reviewImageFull" src="" alt="Review Image"
                                                style="max-width: 90%; max-height: 90%; object-fit: contain; border-radius: 4px; box-shadow: 0 4px 20px rgba(0,0,0,.5);">
                                            <div style="position: absolute; top: 20px; right: 30px; color: #fff; font-size: 30px; cursor: pointer;">
